...
impl<T: Transaction> BlockGasLimitProcessor<T> {
    ...
    pub fn finish_parallel_update_counters_and_log_info(&self, num_committed: u32, num_total: u32) {
        self.finish_update_counters_and_log_info(true, num_committed, num_total)
    }

    pub fn finish_sequential_update_counters_and_log_info(
        &self,
        num_committed: u32,
        num_total: u32,
    ) {
